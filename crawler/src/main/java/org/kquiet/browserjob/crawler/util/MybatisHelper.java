...
public class MybatisHelper {
   ...
   */
  public SqlSessionFactory getSessionFactory(String mybatisFileName,
  ...
  private SqlSessionFactory initSqlSessionFactory(InputStream inputStream, String env) {
  ...
  private void initMapper(InputStream inputStream, String mapperFilePath,
