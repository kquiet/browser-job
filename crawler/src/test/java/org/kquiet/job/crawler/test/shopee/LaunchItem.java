...
public class LaunchItem extends JobBase {
  ...
  private Runnable getJob() {
    ...
    return () -> {
      try {
        ...
        LoginTaskContext loginTask = getLoginBrowserTask(
            getParameter("account"), getParameter("password"), true, true);
  ...
  private LoginTaskContext getLoginBrowserTask(String account, String password,
    ...
    try {
      wrapper.set(new ActionComposerBuilder()
          .prepareActionSequence()
            ...
            .waitUntil(ExpectedConditions.or(
              ...
              ExpectedConditions.and(
                ...
                ExpectedConditions.elementToBeClickable(
                    By.xpath("//*[contains(@class,'signin-form')]//*[text()='登入']")))), 30000)
            .custom(ac -> {
              WebDriver driver = ac.getWebDriver();
              WebElement nicknameE = driver.findElements(
                  By.className("account-header-dropdown__name")).stream().findFirst().orElse(null);
              if (nicknameE != null && nicknameE.isDisplayed()) {
                ...
                if (!nameOnPage.isEmpty()) {
                  if (account.equals(nameOnPage)) {
                    ...
                    ac.skipToFail();
                    wrapper.get().setLoginResultStatus(
                        LoginTaskContext.LoginResultStatus.DifferentLogin);
                    ...
                    new Actions(driver).moveToElement(
                        driver.findElement(
                            By.xpath("//*[contains(@class,'account-header-dropdown__menu-item')"
                                + " and text()='登出']"))).click().build().perform();
                    try {
                      Thread.sleep(3000);
                    } catch (Exception ex) {
            ...
            .prepareSendKey(
                By.xpath("//*[contains(@class,'signin-form')]//input[@placeholder='密碼']"), password)
              .withClearBeforeSend().done()
            ...
            .waitUntil(ExpectedConditions.or(
                ...
                ExpectedConditions.visibilityOfElementLocated(
                    By.className("account-header-dropdown__name"))), 15000)
            .custom(ac -> {
              WebDriver driver = ac.getWebDriver();
              WebElement nicknameE = driver.findElements(
                  By.className("account-header-dropdown__name")).stream().findFirst().orElse(null);
              ...
              WebElement smsBtnE = driver.findElements(
                  By.xpath("//input[@placeholder='驗證碼']")).stream().findFirst().orElse(null);
    ...
    wrapper.get().setOpenWindow(openNewWindowFlag)
      .setCloseWindow(closeWindowFlag).setPriority(Integer.MIN_VALUE);
    return wrapper.get();
  }
          ...
          .prepareActionSequence()
            ...
            .waitUntil(ExpectedConditions.numberOfElementsToBe(
                By.xpath("//*[contains(concat(' ', @class, ' '), ' image-manager ')]//"
                    + "li[starts-with(@data-item,'data:image')]"), 3), 30000)
            .prepareSendKey(
                By.xpath("//*[text()='商品名稱']/following-sibling::*//input"), "itemname")
              .withClearBeforeSend().done()
            .click(By.xpath("//*[@class='placeholder' and starts-with(text(),'商品描述與')]"))
            .waitUntil(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[text()='商品描述']/following-sibling::*//textarea")), 3000)
            .prepareSendKey(
                By.xpath("//*[text()='商品描述']/following-sibling::*//textarea"), "itemdesc")
              .withClearBeforeSend().done()
            .click(By.xpath("//*[text()='選擇類別']"))
            ...
            .justWait(1000)
            .click(By.xpath("//*[contains(@class,'shopee-menu')]//*[text()='其他']"))
            .waitUntil(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@placeholder='設定品牌']")), 3000)
            .prepareSendKey(
                By.xpath("//*[@placeholder='設定品牌']"), "daigobang").withClearBeforeSend().done()
            .prepareSendKey(
                By.xpath("//*[text()='價格']/following-sibling::*//input"), "99999")
              .withClearBeforeSend().done()
            .click(
                By.xpath("//*[contains(concat(' ',@class,' '),"
                  + " ' logistics-setting-panel__section--disabled ')]//*[@class='toggle-button']"))
            .waitUntil(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[contains(text(),'運費選項')]/following-sibling::*[1]//input")), 3000)
            .prepareSendKey(
                By.xpath("//*[contains(text(),'運費選項')]/following-sibling::*[1]//input"), "500")
              .withClearBeforeSend().done()
            .click(By.xpath("//*[text()='開啟此物流方式']"))
            .waitUntil(ExpectedConditions.invisibilityOfElementLocated(
                By.xpath("//*[text()='開啟此物流方式']")), 3000)
            .click(By.xpath("//*[text()='儲存']"))
            .waitUntil(ExpectedConditions.or(
                ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//*[contains(@class, 'alert-box')]"))), 30000)
            .custom(ac -> {
              WebElement alertE = ac.getWebDriver().findElements(
                  By.xpath("//*[contains(@class, 'alert-box')]")).stream().findFirst().orElse(null);
